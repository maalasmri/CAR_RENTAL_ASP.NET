...
namespace KFMCproject.App_Code
{
    public class CURD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["carRentalConnectionString"].ConnectionString;
        // I create a con object once and then use it in methods

        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["carRentalConnectionString"].ConnectionString);
