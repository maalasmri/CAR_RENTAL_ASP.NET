...
<body>
    ...
    <br>
            ...
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Create" CssClass="newStyle13 auto-style7" />
          ...
          <asp:Button ID="btnRead" runat="server" OnClick="btnRead_Click" Text="read" CssClass="newStyle28"/>
                    <br />
                    <br />
                </div>
...
&nbsp;
         ...
         <asp:GridView  ID="gvCars" runat="server" AutoGenerateColumns="False"
            DataKeyNames="carid" CssClass="newStyle18 auto-style9" OnSelectedIndexChanged="gvCars_SelectedIndexChanged">
            <Columns >
